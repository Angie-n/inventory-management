...
router.get('/pokemoninstance/:id/update', pokemoninstance_controller.pokemoninstance_update_get);
router.post('/pokemoninstance/:id/update', pokemoninstance_controller.pokemoninstance_update_post);
